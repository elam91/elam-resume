...
const Intro = () => {
  ...
  return (
    <div className="w-full relative bg-white  bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-40 border border-gray-500 min-h-full rounded-xl flex flex-col">
      {!data ? (
        ...
        <div>
          <div
            className="p-5 h-full  prose text-gray-800 lg:prose-xl font-light prose-headings:font-extralight prose-li:marker:text-black  max-w-none"
